...
/**
 * Glow effect system powered by blurred polygons.
 *
 * Adapted from nekomeowww/talks (2025-05-10-airi-how-we-recreated-it),
 * original credits to @pi0 @Atinux. Recolored with the ElysiaJS palette:
 * blue #60a5fa · fuchsia #e879f9 · pink #f06292 · teal #5eead4 · sky #38bdf8
 *
 * Per-slide frontmatter properties:
 * - glow: 'left' | 'right' | 'top' | 'bottom' | 'full' | ... - distribution of the polygon points
 * - glowOpacity: number - opacity of the polygons (default: 0.4)
...
<template>
  <div>
    ...
    >
      <div
        class="clip bg-gradient-to-r from-[#60a5fa] to-[#e879f9]"
        :style="{ 'clip-path': `polygon(${poly1})`, 'opacity': opacity }"
      />
      <div
        class="clip bg-gradient-to-l from-[#38bdf8] to-[#f06292]"
        :style="{ 'clip-path': `polygon(${poly2})`, 'opacity': opacity }"
      />
      <div
        class="clip bg-gradient-to-t from-[#5eead4] to-[#60a5fa]"
